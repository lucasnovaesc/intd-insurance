...
namespace Domain.Entities
{
    public class Proposal
    {
        ...
        public Proposal(Guid proposalId, long proposalNumber, Guid productId, Guid customerId, DateTime dateCreation, DateTime dateModification, ProposalStatusEnum proposalStatusId)
        {
        ...
        public ProposalStatusEnum ProposalStatusId { get; set; }
